--Table Hosted At  https://sqlzoo.net/wiki/SELECT_within_SELECT_Tutorial
...
SELECT name, continent, population FROM world
  ...
  SELECT name, continent 
FROM world x WHERE population >= ALL (SELECT population*3 FROM world y WHERE y.continent = x.continent 
AND x.name != y.name);
